...
- Sprites, particles, rain and shadows are still software, and so is the interior brick colour (upscaled bilinearly; a pixel-art upscaler would sharpen it).
