...
| [GPU_RENDERER.md](GPU_RENDERER.md) | Opt-in GPU renderer for 3D bodies: per-pixel lighting and true colour over the software frame, how pixels are tagged and composited, flags and limits. |
